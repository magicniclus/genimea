          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8 text-slate-700 flex flex-col items-center">
            ...
            <div className="w-full mt-16 text-sm">
              ...
              <p className="mt-3">
                ...
                vigueur. La version actuelle de ces conditions reste applicable
                tant qu&apos;elle n&apos;est pas remplacée par une nouvelle
                version.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                Le site genimea.com est édité par Genimea, située au : 22 rue de
              ...
              <p className="mt-3">
                L&apos;accès et l&apos;utilisation de genimea.com sont destinés
                à un usage personnel uniquement. Il est interdit d&apos;utiliser
                ce site et les informations qu&apos;il contient à des fins
                commerciales, politiques ou publicitaires, y compris toute forme
                de démarchage, tel que l&apos;envoi de courriels non sollicités.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                ...
                le fonctionnement de genimea.com, ainsi que tous les éléments
                reproduits ou utilisés sur le site, sont protégés par les lois
                sur la propriété intellectuelle et appartiennent à
                l&apos;éditeur Genimea ou à ses partenaires. Toute reproduction,
                représentation, modification ou adaptation de ces éléments sans
              ...
              <p className="mt-3">
                ...
                une acceptation de ces usages ni une renonciation à engager des
                poursuites.
              </p>
              <h3 className="text-lg font-semibold mt-7">
              ...
              <p className="mt-3">
                Pour assurer une gestion efficace du site, Genimea se réserve le
                droit de :
              </p>
              <p className="mt-3">
              ...
              <p className="mt-3">
                ...
                du site genimea.com est soumise à l&apos;autorisation préalable
                et écrite de Genimea. Cette autorisation peut être retirée à
              ...
              <p className="mt-3">
                ...
                genimea.com disposent des droits suivants concernant leurs
              ...
              <p className="mt-3">
                Genimea conserve les données personnelles des utilisateurs pour
                la période nécessaire à la fourniture de ses services. Afin de
                respecter nos obligations légales ou pour résoudre des litiges
                et prévenir les abus, certaines données peuvent être conservées
                même après la clôture d&apos;un compte ou l&apos;inactivité de
              ...
              <p className="mt-3">
                Les conditions d&apos;utilisation de genimea.com sont régies par
                la loi française et tout litige relatif à ces conditions sera
                soumis à la juridiction des tribunaux compétents de Bordeaux.
              </p>
              <h3 className="text-lg font-semibold mt-7">
